...
INSERT INTO "new_ProductionCheckout" ("createdAt", "email", "ente", "id", "name", "pickupDate", "productionName", "restitutionDate", "surname", "techPerson", "telephone", "type", "updatedAt") SELECT "createdAt", "email", "ente", "id", "name", "pickupDate", "productionName", "restitutionDate", "surname", "techPerson", "telephone", "type", "updatedAt" FROM "ProductionCheckout";
